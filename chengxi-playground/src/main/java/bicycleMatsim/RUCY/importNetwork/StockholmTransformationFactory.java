...
public class StockholmTransformationFactory extends TransformationFactory{
	public final static String WGS84_RT90 = "WGS84_RT90"; // FIXME there is no "to" here
	public final static String WGS84_SWEREF99 = "WGS84_SWEREF99"; // FIXME there is no "to" here
